...
public:
  ...
  DeviceFanControl(FanControlExtrasDelegate* aOptionalFanControlExtrasDelegateP, LevelControlDelegate& aLevelControlDelegate, IdentifyDelegate* aIdentifyDelegateP, DeviceInfoDelegate& aDeviceInfoDelegate);
