...
class P44DeviceInfoProvider : public DeviceInfoProvider
{
public:
  P44DeviceInfoProvider() = default;
  ~P44DeviceInfoProvider() override {}
  ...
  static P44DeviceInfoProvider & GetDefaultInstance();
...
protected:
  ...
  {
  public:
    UserLabelIteratorImpl(P44DeviceInfoProvider & provider, EndpointId endpoint);
    size_t Count() override { return mTotal; }
    bool Next(UserLabelType & output) override;
    void Release() override { chip::Platform::Delete(this); }

  private:
    P44DeviceInfoProvider & mProvider;
    EndpointId mEndpoint = 0;
    size_t mIndex        = 0;
    size_t mTotal        = 0;
