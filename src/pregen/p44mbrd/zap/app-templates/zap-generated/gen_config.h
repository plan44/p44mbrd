...
#define EMBER_AF_BRIDGED_DEVICE_BASIC_INFORMATION_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
#define MATTER_SCENES_TABLE_SIZE 64
...
#define EMBER_AF_PLUGIN_BRIDGED_DEVICE_BASIC_INFORMATION_SERVER
#define EMBER_AF_PLUGIN_BRIDGED_DEVICE_BASIC_INFORMATION
